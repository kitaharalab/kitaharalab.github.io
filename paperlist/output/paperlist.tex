...
\underline{Tetsuro Kitahara}: 
    ...
    {\it 15th International Symposium on Computer Music Multidisciplinary Research,
    } November 2021. 
...
\underline{Tetsuro Kitahara}: 
    ...
    {\it Music in the AI Era: 15th International Symposium, CMMR 2021, Virtual Event, November 15-19, 2021, Revised Selected Papers,
    } LNCS 13770, pp.69--75, June 2023. 
...
Kanako Baba: 
    ...
    {\it Proceedings of the 16th International Symposium on Computer Music Multidisciplinary Research,
    } pp.78--85, November 2023. 
...
\underline{Tetsuro Kitahara}: 
    ...
    {\it Proceedings of the 16th International Symposium on Computer Music Multidisciplinary Research,
    } pp.784--787, November 2023. 

\item 
\underline{Tetsuro Kitahara}, 
Akio Yonamine: 
    ``JamSketch Deep α: Towards Musical Improvisation
based on Human-machine Collaboration'', 
    {\it NeurIPS 2023 Workshop on Machine Learning for Creativity and Design,
    } December 2023. 
...
\underline{Tetsuro Kitahara}: 
    ...
    {\it 2024 AES 6th International Conference on Audio for Games (AES 2024),
    } April 2024. 
...
and 
\underline{Tetsuro Kitahara}: 
    ``Automatic Drum Velocity Control Considering the User’s Piano Performance'', 
    {\it Proceedings of the 2024 IEEE Global Conference on Consumer Electronics (GCCE 2024),
    } pp.1377--1380, November 2024. 
...
北原鉄朗: 
    ...
    {\it 音学シンポジウム2023,
    } 2023-MUS-137-52 / 2023-SLP-147-52, June 2023. 

\item 
大下沙偉, 
大澤智恵, 
北原鉄朗: 
    ``フルート支援システムのための音響分析: 決定木と線形回帰を用いた自動評価の検討'', 
    {\it 日本音響学会音楽音響研究会資料,
    } Vol.42, No.9, pp.5--10, February 2024. 

\item 
大川 真由子, 
姜 楊禹辰, 
\underline{北原 鉄朗}: 
    ``スケール練習のための楽譜生成システムの試作'', 
    {\it インタラクション2024（インタラクティブ発表）,
    } 2B46, March 2024. 
...
北原鉄朗: 
    ...
    {\it Entertainment Computing 2024,
    } September 2024. 
...
大澤 智恵, 
\underline{北原 鉄朗}: 
    ``フルートの支援システムのための音響分析：演奏音の自動分類の検討'', 
    {\it 日本音響学会2023年秋季研究発表会,
    } 2-4-4, September 2023. 

\item 
林 龍星, 
\underline{北原 鉄朗}: 
    ``ゲーム映像からBGMを予測するための機械学習モデル'', 
    {\it 日本音響学会2023年秋季研究発表会,
    } 3-4-13, September 2023. 

\item 
香西 智雄, 
\underline{北原 鉄朗}: 
    ``クロマグラムとCNNを用いたギター音源からベース音源の生成の試み'', 
    {\it 日本音響学会2023年秋季研究発表会,
    } 3-4-15, September 2023. 

\item 
岩本 祐輝, 
尾上 洋介, 
\underline{北原 鉄朗}: 
    ``盛り上がり度に基づくループシーケンサ：Webアプリ化のためのフロントエンドの実装'', 
    {\it 日本音響学会2023年秋季研究発表会,
    } 3-4-19, September 2023. 
...
北原鉄朗: 
    ...
    {\it 第141回音楽情報科学研究発表会 (MUS141),
    } August 2024. 

\item 
林 龍星, 
\underline{北原 鉄朗}: 
    ``ゲームとシーンの特徴を考慮するBGM検索エンジンの開発：主観評価の実施'', 
    {\it 第142回音楽情報科学研究発表会 (MUS142),
    } March 2025. 
