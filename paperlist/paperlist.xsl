  ...
  <html>
    ...
    <body>
      ...
      <xsl:if test="item[@type='jj' or @type='ij']">
          ...
          <ol>
            <xsl:apply-templates select="item[@type='jj' or @type='ij']">
              <xsl:sort select="year" data-type="number" order="descending"/>
              <xsl:sort select="month" data-type="number" order="descending"/>
            </xsl:apply-templates>
          </ol>
      </xsl:if>
      <!-- SHORT PAPERS (lang=jp> -->
      <xsl:if test="item[@type='lt']">
          <h3>ショートペーパー (Short Papers published in Journals)</h3>
          <ol>
      ...
      <xsl:if test="item[@type='dr']">
          <h3>国内査読つき会議 (Domestic Refereed Proceedings)</h3>
          <ol>
      ...
      <xsl:if test="item[@type='dt']">
          <h3>国内研究会 (Domestic Technical Reports)</h3>
          <ol>
      ...
      <xsl:if test="item[@type='dc']">
          <h3>全国大会 (Domestic Convension Papers)</h3>
          <ol>
      ...
      <xsl:if test="item[@type='op']">
          <h3>予稿無し発表 (No-paper Presentations)</h3>
          <ol>
